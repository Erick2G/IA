...
public class RepMut {
    ...
    public static void reproducir() {
        ...
        if (poblacion.size() > 1) {
            ...
            int posiblesPadres = (int) (seMantienen + .10 *(evaluacion.size()-seMantienen));
            double siguenVivos;
            if(seMantienen==0){
                siguenVivos = 1 + (evaluacion.size()-1) * .20;// la poblacion que seguira viva
            }else{
                siguenVivos = seMantienen;
            }
